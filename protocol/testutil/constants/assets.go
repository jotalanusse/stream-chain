...
const (
	...
	TestFee = "50000000000000000" + asstypes.TDaiDenom // 5 cents
	...
	TestGasLimit = 1_000_000_000_000_000_000
...
var (
	...
	TDai = &asstypes.Asset{
		...
		DenomExponent:    asstypes.AssetTDai.DenomExponent,
		HasMarket:        false,
		MarketId:         uint32(0),
		AtomicResolution: asstypes.AssetTDai.DenomExponent,
	}
)
