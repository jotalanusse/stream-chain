			...
			expectedMatches: []*MatchWithOrdersForTesting{
				{
					...
					TotalFilledMaker: constants.BaseQuantums_100_000_000,
					TotalFilledTaker: constants.BaseQuantums_100_000_000,
				},
			},
			expectedProcessProposerMatchesEvents: types.ProcessProposerMatchesEvents{
			...
			expectedMatches: []*MatchWithOrdersForTesting{
				{
					MatchWithOrders: types.MatchWithOrders{
						...
						FillAmount: constants.BaseQuantums_5,
					},
					TotalFilledMaker: constants.BaseQuantums_5,
					TotalFilledTaker: constants.BaseQuantums_5,
				},
			},
			expectedProcessProposerMatchesEvents: types.ProcessProposerMatchesEvents{
				OrderIdsFilledInLastBlock: []types.OrderId{
			...
			expectedMatches: []*MatchWithOrdersForTesting{
				{
					MatchWithOrders: types.MatchWithOrders{
						...
						FillAmount: constants.BaseQuantums_10,
					},
					TotalFilledMaker: constants.BaseQuantums_10,
					TotalFilledTaker: constants.BaseQuantums_10,
				},
				{
					MatchWithOrders: types.MatchWithOrders{
						TakerOrder: &types.Order{
						...
						MakerOrder: &constants.LongTermOrder_Alice_Num0_Id0_Clob0_Buy100_Price10_GTBT15,
						FillAmount: constants.BaseQuantums_15,
					},
					TotalFilledMaker: constants.BaseQuantums_25,
					TotalFilledTaker: constants.BaseQuantums_15,
				},
			},
			...
			expectedMatches: []*MatchWithOrdersForTesting{
				{
					MatchWithOrders: types.MatchWithOrders{
						...
						FillAmount: constants.BaseQuantums_25_000_000,
						MakerFee:   2_500_000,
						TakerFee:   0,
					},
					TotalFilledMaker: constants.BaseQuantums_25_000_000,
					TotalFilledTaker: constants.BaseQuantums_25_000_000,
				},
			},
			expectedProcessProposerMatchesEvents: types.ProcessProposerMatchesEvents{
				OrderIdsFilledInLastBlock: []types.OrderId{
