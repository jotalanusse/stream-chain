...
const (
	...
	// REMOVAL_REASON_INSUFFICIENT_BALANCE represents a removal of an order which
	// if filled in isolation with respect to the current state of the
	// subaccount would leave the subaccount with negative balance.
	OrderRemoval_REMOVAL_REASON_INSUFFICIENT_BALANCE OrderRemoval_RemovalReason = 2
	...
	// or change sides.
	OrderRemoval_REMOVAL_REASON_INVALID_REDUCE_ONLY OrderRemoval_RemovalReason = 3
	...
	OrderRemoval_REMOVAL_REASON_POST_ONLY_WOULD_CROSS_MAKER_ORDER OrderRemoval_RemovalReason = 4
	...
	// proposers orderbook.
	OrderRemoval_REMOVAL_REASON_INVALID_SELF_TRADE OrderRemoval_RemovalReason = 5
	...
	OrderRemoval_REMOVAL_REASON_CONDITIONAL_FOK_COULD_NOT_BE_FULLY_FILLED OrderRemoval_RemovalReason = 6
	...
	OrderRemoval_REMOVAL_REASON_CONDITIONAL_IOC_WOULD_REST_ON_BOOK OrderRemoval_RemovalReason = 7
	...
	OrderRemoval_REMOVAL_REASON_FULLY_FILLED OrderRemoval_RemovalReason = 8
	// REMOVAL_REASON_VIOLATES_ISOLATED_SUBACCOUNT_CONSTRAINTS represents a removal of an order that
	//  would lead to the subaccount violating isolated subaccount constraints.
	OrderRemoval_REMOVAL_REASON_VIOLATES_ISOLATED_SUBACCOUNT_CONSTRAINTS OrderRemoval_RemovalReason = 9
)

var OrderRemoval_RemovalReason_name = map[int32]string{
	0: "REMOVAL_REASON_UNSPECIFIED",
	1: "REMOVAL_REASON_UNDERCOLLATERALIZED",
	2: "REMOVAL_REASON_INSUFFICIENT_BALANCE",
	3: "REMOVAL_REASON_INVALID_REDUCE_ONLY",
	4: "REMOVAL_REASON_POST_ONLY_WOULD_CROSS_MAKER_ORDER",
	5: "REMOVAL_REASON_INVALID_SELF_TRADE",
	6: "REMOVAL_REASON_CONDITIONAL_FOK_COULD_NOT_BE_FULLY_FILLED",
	7: "REMOVAL_REASON_CONDITIONAL_IOC_WOULD_REST_ON_BOOK",
	8: "REMOVAL_REASON_FULLY_FILLED",
	9: "REMOVAL_REASON_VIOLATES_ISOLATED_SUBACCOUNT_CONSTRAINTS",
}

var OrderRemoval_RemovalReason_value = map[string]int32{
	"REMOVAL_REASON_UNSPECIFIED":                               0,
	"REMOVAL_REASON_UNDERCOLLATERALIZED":                       1,
	"REMOVAL_REASON_INSUFFICIENT_BALANCE":                      2,
	"REMOVAL_REASON_INVALID_REDUCE_ONLY":                       3,
	"REMOVAL_REASON_POST_ONLY_WOULD_CROSS_MAKER_ORDER":         4,
	"REMOVAL_REASON_INVALID_SELF_TRADE":                        5,
	"REMOVAL_REASON_CONDITIONAL_FOK_COULD_NOT_BE_FULLY_FILLED": 6,
	"REMOVAL_REASON_CONDITIONAL_IOC_WOULD_REST_ON_BOOK":        7,
	"REMOVAL_REASON_FULLY_FILLED":                              8,
	"REMOVAL_REASON_VIOLATES_ISOLATED_SUBACCOUNT_CONSTRAINTS":  9,
}
...
var fileDescriptor_60fa12f781955c9f = []byte{
	...
	,
}
