...
// CreatePerpetual provides a mock function with given fields: ctx, id, ticker, marketId, atomicResolution, defaultFundingPpm, liquidityTier, marketType, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId
func (_m *PerpetualsKeeper) CreatePerpetual(ctx types.Context, id uint32, ticker string, marketId uint32, atomicResolution int32, defaultFundingPpm int32, liquidityTier uint32, marketType perpetualstypes.PerpetualMarketType, dangerIndexPpm uint32, maxCumulativeInsuranceFundDeltaPerBlock uint64, marketMultiCollateralAssets *perpetualstypes.MultiCollateralAssetsArray, quoteAssetId uint32) (perpetualstypes.Perpetual, error) {
	ret := _m.Called(ctx, id, ticker, marketId, atomicResolution, defaultFundingPpm, liquidityTier, marketType, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	...
	if rf, ok := ret.Get(0).(func(types.Context, uint32, string, uint32, int32, int32, uint32, perpetualstypes.PerpetualMarketType, uint32, uint64, *perpetualstypes.MultiCollateralAssetsArray, uint32) (perpetualstypes.Perpetual, error)); ok {
		return rf(ctx, id, ticker, marketId, atomicResolution, defaultFundingPpm, liquidityTier, marketType, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint32, string, uint32, int32, int32, uint32, perpetualstypes.PerpetualMarketType, uint32, uint64, *perpetualstypes.MultiCollateralAssetsArray, uint32) perpetualstypes.Perpetual); ok {
		r0 = rf(ctx, id, ticker, marketId, atomicResolution, defaultFundingPpm, liquidityTier, marketType, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	} else {
	...
	if rf, ok := ret.Get(1).(func(types.Context, uint32, string, uint32, int32, int32, uint32, perpetualstypes.PerpetualMarketType, uint32, uint64, *perpetualstypes.MultiCollateralAssetsArray, uint32) error); ok {
		r1 = rf(ctx, id, ticker, marketId, atomicResolution, defaultFundingPpm, liquidityTier, marketType, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *PerpetualsKeeper) GetMarginRequirements(ctx types.Context, id uint32, bigQuantums *big.Int, quoteCurrencyAtomicResolution int32) (*big.Int, *big.Int, error) {
	...
	var r1 *big.Int
	var r2 error
	if rf, ok := ret.Get(0).(func(types.Context, uint32, *big.Int, int32) (*big.Int, *big.Int, error)); ok {
		return rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint32, *big.Int, int32) *big.Int); ok {
		r0 = rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(types.Context, uint32, *big.Int, int32) *big.Int); ok {
		r1 = rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(types.Context, uint32, *big.Int, int32) error); ok {
		r2 = rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *PerpetualsKeeper) GetNetCollateral(ctx types.Context, id uint32, bigQuantums *big.Int, quoteCurrencyAtomicResolution int32) (*big.Int, error) {
	...
	var r0 *big.Int
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, uint32, *big.Int, int32) (*big.Int, error)); ok {
		return rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint32, *big.Int, int32) *big.Int); ok {
		r0 = rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	...
	if rf, ok := ret.Get(1).(func(types.Context, uint32, *big.Int, int32) error); ok {
		r1 = rf(ctx, id, bigQuantums, quoteCurrencyAtomicResolution)
	} else {
		r1 = ret.Error(1)
	}
...
// ModifyPerpetual provides a mock function with given fields: ctx, id, ticker, marketId, defaultFundingPpm, liquidityTier, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId
func (_m *PerpetualsKeeper) ModifyPerpetual(ctx types.Context, id uint32, ticker string, marketId uint32, defaultFundingPpm int32, liquidityTier uint32, dangerIndexPpm uint32, maxCumulativeInsuranceFundDeltaPerBlock uint64, marketMultiCollateralAssets *perpetualstypes.MultiCollateralAssetsArray, quoteAssetId uint32) (perpetualstypes.Perpetual, error) {
	ret := _m.Called(ctx, id, ticker, marketId, defaultFundingPpm, liquidityTier, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	...
	if rf, ok := ret.Get(0).(func(types.Context, uint32, string, uint32, int32, uint32, uint32, uint64, *perpetualstypes.MultiCollateralAssetsArray, uint32) (perpetualstypes.Perpetual, error)); ok {
		return rf(ctx, id, ticker, marketId, defaultFundingPpm, liquidityTier, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint32, string, uint32, int32, uint32, uint32, uint64, *perpetualstypes.MultiCollateralAssetsArray, uint32) perpetualstypes.Perpetual); ok {
		r0 = rf(ctx, id, ticker, marketId, defaultFundingPpm, liquidityTier, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	} else {
		r0 = ret.Get(0).(perpetualstypes.Perpetual)
	}
	...
	if rf, ok := ret.Get(1).(func(types.Context, uint32, string, uint32, int32, uint32, uint32, uint64, *perpetualstypes.MultiCollateralAssetsArray, uint32) error); ok {
		r1 = rf(ctx, id, ticker, marketId, defaultFundingPpm, liquidityTier, dangerIndexPpm, maxCumulativeInsuranceFundDeltaPerBlock, marketMultiCollateralAssets, quoteAssetId)
	} else {
		r1 = ret.Error(1)
	}
