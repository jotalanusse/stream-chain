...
export enum OrderRemovalReason {
  ...
  /**
   * ORDER_REMOVAL_REASON_VIOLATES_COLLATERAL_POOL_CONSTRAINTS - The order has been removed since filling it would lead to the subaccount
...
export function orderRemovalReasonFromJSON(object: any): OrderRemovalReason {
  switch (object) {
    ...
    case 15:
    case "ORDER_REMOVAL_REASON_VIOLATES_COLLATERAL_POOL_CONSTRAINTS":
      return OrderRemovalReason.ORDER_REMOVAL_REASON_VIOLATES_COLLATERAL_POOL_CONSTRAINTS;
...
export function orderRemovalReasonToJSON(object: OrderRemovalReason): string {
  switch (object) {
    ...
    case OrderRemovalReason.ORDER_REMOVAL_REASON_VIOLATES_COLLATERAL_POOL_CONSTRAINTS:
      return "ORDER_REMOVAL_REASON_VIOLATES_COLLATERAL_POOL_CONSTRAINTS";
